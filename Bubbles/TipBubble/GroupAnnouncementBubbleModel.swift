//
//  GroupAnnouncementBubbleModel.swift
//  String
//
...
class GroupAnnouncementBubbleModel: TipBubbleModel, BubbleInfoProtocol {
    ...
    required init?(rcMessages: [RCMessage], currentUserId: String) {
        ...
        guard let rcMessage = rcMessages.first,
              let groupAnnouncementMsg = rcMessage.content as? UMBGroupAnnouncementNotificationMessage else {
            return
        }
        
        // TODO: - 群公告字符串拼接
        messageString = groupAnnouncementMsg.announcement
